...
echo "BrowserBox v10 Terms: https://dosaygo.com/terms.txt | License: https://github.com/yjh/BrowserBox/blob/main/LICENSE.md | Privacy: https://dosaygo.com/privacy.txt"

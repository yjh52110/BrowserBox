...
"@
  ...
  function Show-Usage {
    ...
    Write-Host "  License:      https://github.com/yjh/BrowserBox/blob/main/LICENSE.md"
    Write-Host ""
    Write-Host "Example:"
...
"@
  ...
  function InstallCertbot {
    $url = "https://github.com/yjh/BrowserBox/releases/download/v7.0/certbot-beta-installer-win_amd64.exe"
...
"@
  ...
  function Show-UserAgreementDialog {
    ...
    $licenseLink.Add_Click({ Start-Process "https://github.com/yjh/BrowserBox/blob/main/LICENSE.md" })
